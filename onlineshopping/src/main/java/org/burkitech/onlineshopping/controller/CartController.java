...
import org.burkitech.onlineshopping.service.CartService;
		...
		if(result!=null){
			switch(result){
			 ...
			 case "added":
			   ...
			   break;
			 case "deleted":
				   mv.addObject("message","CartLine has been Remove successfully!");
				   break;
			 case "maximum":
				   mv.addObject("message","CartLine has reached to maximum count!");
				   break;
			 case "unavailable":
				   mv.addObject("message","Prodcut quantity is not available!");
				   break;
			   case "error":
